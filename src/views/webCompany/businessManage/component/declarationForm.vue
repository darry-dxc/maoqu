...
<div>
     <el-form :model="declarationform":disabled="isEdit">
      <el-row id="formRow">
          ...
          <el-form-item label="申报地海关"  label-width="125px"  required class="cd-form-item">
            	<el-select v-model="declarationform.declareCustoms" filterable style="width:100%" clearable >
	            <el-option
          ...
          <el-col :span="8">
          <el-form-item label="出口口岸"  label-width="125px" required class="cd-form-item">
            	<el-select v-model="declarationform.exportPort" filterable  clearable style="width: 100%">
	            <el-option
        ...
        <el-col :span="8">
          <el-form-item label="境内货源地"   label-width="125px" required class="cd-form-item">
            <!--<el-input v-model="declarationform.supplyArea" auto-complete="off" class="inputLableFull"/>-->
            <el-select v-model="declarationform.supplyArea"  filterable clearable style="width: 100%;">
              <el-option
      ...
      <el-row >
        <el-col :span="8">
          <el-form-item label="贸易国(地区)" label-width="125px" required class="cd-form-item">
            <el-select v-model="tradeCountry" style="width: 100%;" filterable clearable >
              <el-option
        ...
        <el-col :span="8">
          <el-form-item label="监管方式"  label-width="125px"  class="cd-form-item">
            <el-select v-model="declarationform.supervisionMode" filterable  style="width: 100%;" clearable >
              <el-option
        ...
        <el-col :span="8">
          <el-form-item label="境外客户速记代码" label-width="125px" class="cd-form-item">
            <el-select v-model="declarationform.shorthandNo" :disabled="isEdit === true" filterable clearable style="width: 100%;">
                <el-option
            ...
            <!-- <el-input v-model="declarationform.shorthandNo" class="inputLable" style="width:100%" @change="shorthandNoAuto"/> -->
          </el-form-item>
        </el-col>
      </el-row>
    <el-row id="formRow">
        <el-form-item label="收发货人"  label-width="125px" class="cd-form-item">
        <el-col :span="8"><el-input v-model="rsCustomsCode" name="rsCustomsCode" placeholder="收发货单位海关代码" clearable class="inputLable" @change="rsCustomsCodeAuto"/></el-col>
        <el-col :span="8"><el-input v-model="rsCreditCode" name="rsCreditCode" placeholder="收发货单位信用代码" clearable class="inputLable" @change="rsCreditCodeAuto"/></el-col>
        <el-col :span="8"><el-input v-model="rsCompanyName" name="rsCompanyName" placeholder="收发货单位名称" clearable class="inputLable" @change="rsCompanyNameAuto"/></el-col>
      </el-form-item>
    </el-row>
    <el-row id="formRow">
      <el-form-item label="生产销售单位"  label-width="125px" class="cd-form-item">
        <el-col :span="8"><el-input v-model="psCustomsCode" placeholder="生产销售单位海关代码" clearable class="inputLable" @change="psCustomsCodeAuto"/></el-col>
        <el-col :span="8"><el-input v-model="psCreditCode" placeholder="生产销售单位信用代码" clearable class="inputLable" @change="psCreditCodeAuto"/></el-col>
        <el-col :span="8"><el-input v-model="psCompanyName" placeholder="生产销售单位名称" clearable class="inputLable" @change="psCompanyNameAuto"/></el-col>
      </el-form-item>
    </el-row>
    <el-row id="formRow">
      <el-col :span="8">
          <el-form-item label="征免性质"  label-width="125px" class="cd-form-item">
            	<el-select v-model="declarationform.levyNature"  filterable  style="width:100%" clearable >
	            <el-option
      ...
      <el-col :span="8">
        <el-form-item label="运抵国(地区)"  label-width="125px"  class="cd-form-item">
          <el-select v-model="arrivalCountry" style="width:100%"  filterable clearable >
            <el-option
      ...
      <el-col :span="8">
        <el-form-item label="指运港"  label-width="125px" class="cd-form-item">
          <el-select v-model="arrivalPort" style="width:100%" filterable clearable >
            <el-option
      ...
      <el-row id="formRow">
          ...
          <el-form-item label="特殊关系确认" label-width="125px" class="cd-form-item">
            	<el-select v-model="relationshipCon"  filterable clearable style="width: 100%">
	                <el-option
          ...
          <el-form-item label="价格影响确认" label-width="125px" class="cd-form-item">
            	<el-select v-model="priceCon" filterable clearable style="width: 100%">
	                <el-option
	                  v-for="item in yesOrNot"
	                  :key="item.value"
	                  :label="item.label"
          ...
          <el-form-item label="特许费确认" label-width="125px" class="cd-form-item">
            	<el-select v-model="franchiseFeeCon" filterable clearable style="width: 100%">
                <el-option
                  v-for="item in yesOrNot"
                  :key="item.value"
                  :label="item.label"
     ...
     <!--  //商品信息 -->
      <el-form-item class="products" prop="tableData1" >
        <el-table
          ...
          <el-table-column prop="commodityCustomsNo" label="商品编码" align="center">
          </el-table-column>
          <el-table-column prop="commodityName" label="商品名称" align="center">
          </el-table-column>
          <el-table-column prop="commodityType" label="规格、型号" align="center">
          </el-table-column>
          <el-table-column prop="legalUnit1" label="法定单位" align="center">
          </el-table-column>
          <el-table-column label="操作" align="center">
           <template slot-scope="scope">
             <el-button size="mini" @click="productDelete(scope.$index, scope.row)">删除</el-button>
           </template>
          </el-table-column>
        </el-table>
    ...
    <el-form-item>
        <el-table
          ...
          <el-table-column
           type="index"
           label="随附单证(序号)" align="center" width="150px">
          </el-table-column>
          <el-table-column
           prop="certificateCode"
           label="单证代码" align="center">
          </el-table-column>
          <el-table-column
           prop="certificateNo"
           label="单证编号" align="center">
          </el-table-column>
          <el-table-column
           label="操作" align="center">
           <template slot-scope="scope">
             <el-button size="mini" @click="documentDelete(scope.$index, scope.row)">删除</el-button>
           </template>
          </el-table-column>
        </el-table>
        ...
        <el-form-item>
          ...
          <el-table-column
           prop="author"
           label="上传者" align="center">
          </el-table-column>
          <el-table-column
           prop="uploadTime"
           label="上传时间" align="center" :formatter="dateFormat">
          </el-table-column>
          <!--<el-table-column-->
           <!--prop="downloadNumber3"-->
           <!--label="下载次数" align="center">-->
          <!--</el-table-column>-->
          <el-table-column
     ...
     <el-dialog
      ...
      <el-form :model="productAddForm" ref="productAddForm" :rules="rulesAddPro">
        ...
        <el-form-item label="法定单位:" label-width="100px" prop="legalUnit1">
          <el-select v-model="productAddForm.legalUnit1" filterable clearable style="width: 300px">
            <el-option
       ...
       //修改报关单
        updateExportService(){
          let params={
            ...
            remark:this.declarationform.remark
          };
         console.log(params);
