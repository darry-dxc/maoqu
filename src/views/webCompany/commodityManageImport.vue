<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="domesticDestinationCode" label="境内目的地" :formatter="domesticDestinationCodeName"/>
      <el-table-column prop="commodityType" label="规格/型号" />
...
<script>
  ...
  import Add from './../../views/webCompany/commodityImport/commodityAdd';//新增弹出框
  import Edit from './../../views/webCompany/commodityImport/commodityEdit';//编辑弹出框
  import Delete from './../../views/webCompany/commodityImport/commodityDel';//删除弹出框
  export default {
    //定义数据
    data () {
      return {
    ...
    methods:{
      ...
      //查询商品
      queryCommodity(){
        this.$axios3.post('import/getCommodity',{
