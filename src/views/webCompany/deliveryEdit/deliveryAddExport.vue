    ...
    export default {
      ...
      data() {
        return {
          ...
          formLabelWidthLeft: '150px',
              formLabelWidthRight: '240px',
        }
      },
      //定义初始化函数
      mounted(){
      ...
      methods:{
        ...
        AddDelivery(){
          ...
          console.log(this.form.enterprisecreditcode,'ssss')
          ...
          this.$axios3.post('/addDeliveryEnterprise',param)
          .then((res) => {
            console.log(res.data);
            if(res.data.code === 200){
              this.$message.success('境内收发货人添加成功!');
              this.deliveryId=res.data.data.deliveryId;
        ...
        showDelivery(id){
          ...
          this.$axios3.post('commodityEnterprise/getRevEnterprise',{
            receiveEnterpriseId:id
          }).then((res) => {
            console.log(res.data);
            if(res.data.code === 200)
        ...
        setCallbackData(){
          ...
          if(this.name2 !== ''){
            param.recordForm = this.deliveryId+'/'+this.nickCompanyId+'/delivery/'+this.name2
          }
          if(this.name3 !== ''){
            param.registrateCertificate = this.deliveryId+'/'+this.nickCompanyId+'/delivery/'+this.name3
          }
