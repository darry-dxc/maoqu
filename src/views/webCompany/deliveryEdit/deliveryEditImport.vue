  ...
  export default {
    ...
    methods:{
      ...
      editDelivery(val){
        ...
        this.receiveEnterpriseId = val;
        this.$axios3.post('/getRevEnterprise',{
          receiveEnterpriseId:val
        }).then((res) => {
      ...
      saveInfo(){
        ...
        let param = {
          receiveEnterpriseId:this.receiveEnterpriseId,
        ...
        this.$axios3.post('/updateRevEnterprise',param)
          .then((res) => {
      ...
      //删除文件
      deleteFile(){
        this.$axios11.post('bsFile/Delivery/Delete',{
      ...
      setCallbackData(){
        ...
        if(this.name2 !== ''){
          param.registrateCertificate = this.receiveEnterpriseId+'/'+this.nickCompanyId+'/receiveEnterprise/'+this.name2
        }
        if(this.name3 !== ''){
          param.recordForm = this.receiveEnterpriseId+'/'+this.nickCompanyId+'/receiveEnterprise/'+this.name3
        }
