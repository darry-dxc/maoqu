...
<script>
  ...
  import Views from './../../../views/webManager/checkDocument/docReviewForm';
  export default {
    //定义数据
    data () {
      return {
...
//定义初始化函数
    ...
    methods:{
      ...
      queryDocByKeyword(){
        ...
        this.documentData=[];
        this.$axios8.post('/getVerifiedOrUnverifiedInfos',{
      ...
      getAuditOpinionId(row){
        console.log(row)
        this.viewAuditOpinion(row.imDeclareDetailId);
      },
      //查看历史审核意见
      viewAuditOpinion(id){
