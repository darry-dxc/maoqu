<template>
  <div>
    <el-button type="primary" @click="dialogFormVisible = true" class="addBtn" :disabled="isDisabled === true">查看资源</el-button>
    <el-dialog title="查看资源" :visible.sync="dialogFormVisible" width="1000px">
