<template>
  <el-form :model="form" ref="form" :rules="rules" :show-message="false" size="small">
    <el-row>
      <el-col :span="12">
        <el-form-item label="申报地海关" prop="declareCustoms" label-width="110px" class="formItem" required>
          <el-select v-model="form.declareCustoms" size="small" :filter-method="declareCustomFilter" filterable clearable :disabled="isEdit" style="width: 100%;">
            <el-option
    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item label="进境关别" prop="enterBorder" required label-width="110px" class="formItem">
          <el-select v-model="form.enterBorder" size="small" :filter-method="enterBorderFilter" filterable clearable :disabled="isEdit" style="width: 100%;">
            <el-option
              v-for="item in enterBordersAll"
              :key="item.value"
              :label="item.label"
              :value="item.value">
              <span style="float: left">{{ item.value }}</span>
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item label="备案号" prop="recordNo" label-width="110px" class="formItem">
          <el-input v-model="form.recordNo" size="small" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="合同协议号"  label-width="110px" class="formItem">
          <el-input v-model="form.contractNo"  size="small" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12">
        <el-form-item label="进口日期" prop="importDate" label-width="110px" class="formItem" required>
          <el-date-picker
            style="width: 100%"
    ...
    <el-row>
      <el-col :span="9">
        <el-form-item label="境内收发货人" prop="teRsCreditCode" label-width="110px" class="formItem" required>
          <el-autocomplete
      ...
      <el-col :span="3">
        <el-form-item class="formItem" prop="teRsCustomsCode" required>
          <el-input v-model="form.teRsCustomsCode"  size="small" placeholder="10位海关代码" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="3">
        <el-form-item class="formItem" prop="teRsQuarantineCode">
          <el-input v-model="form.teRsQuarantineCode"  size="small" placeholder="10位检验检疫编码" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="9">
        <el-form-item class="formItem" prop="teRsComanyName" required>
          <el-input v-model="form.teRsComanyName"  size="small" placeholder="企业名称(中文)" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="9">
        <el-form-item class="formItem" prop="ovRsComanyName" required>
          <el-input v-model="form.ovRsComanyName"  size="small" placeholder="企业名称(外文)" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="9">
        <el-form-item label="消费使用单位" prop="csCreditCode" required label-width="110px" class="formItem">
          <el-input v-model="form.csCreditCode"  size="small" placeholder="18位社会信用证代码" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="3">
        <el-form-item class="formItem" prop="csCustomsCode" required>
          <el-input v-model="form.csCustomsCode"  size="small" placeholder="10位海关代码" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="3">
        <el-form-item class="formItem" prop="csQuarantineCode">
          <el-input v-model="form.csQuarantineCode"  size="small" placeholder="10位检验检疫编码" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="9">
        <el-form-item class="formItem" prop="csCompanyName" required>
          <el-input v-model="form.csCompanyName"  size="small" placeholder="企业名称(中文)" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="9">
        <el-form-item label="申报单位" prop="decCreditCode" required label-width="110px" class="formItem">
          <el-input v-model="form.decCreditCode"  size="small" placeholder="18位企业信用证代码" disabled/>
        </el-form-item>
      </el-col>
      <el-col :span="3">
        <el-form-item class="formItem" prop="decCustomsCode" required>
          <el-input v-model="form.decCustomsCode"  size="small" placeholder="10位海关代码" disabled/>
        </el-form-item>
      </el-col>
      <el-col :span="3">
        <el-form-item class="formItem" prop="decQuarantineCode">
          <el-input v-model="form.decQuarantineCode"  size="small" placeholder="10位检验检疫编码" disabled/>
        </el-form-item>
      </el-col>
      <el-col :span="9">
    ...
    <el-row>
      <el-col :span="6">
        <el-form-item label="运输方式" prop="transportMode" label-width="110px" class="formItem" required>
          <el-select v-model="form.transportMode" size="small" :filter-method="transportModeFilter" :disabled="isEdit" filterable clearable style="width: 100%;">
            <el-option
      ...
      <el-col :span="6">
        <el-form-item label="运输工具名称"  label-width="110px" class="formItem">
          <el-input v-model="form.conveyanceName"  size="small" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="航次号"  label-width="110px" class="formItem">
          <el-input v-model="form.voyageNo" size="small" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12">
        <el-form-item label="提运单号"  label-width="110px" class="formItem">
          <el-input v-model="form.deliveryNo" size="small" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="6">
        <el-form-item label="监管方式" prop="supervisionMode" label-width="110px" class="formItem" required>
          <el-select v-model="form.supervisionMode" size="small" :filter-method="superviseModesFilter" :disabled="isEdit" filterable clearable style="width: 100%;">
            <el-option
      ...
      <el-col :span="6">
        <el-form-item label="征免性质"  label-width="110px" class="formItem">
          <el-select v-model="form.levyNature" size="small" :filter-method="levyNaturesFilter" :disabled="isEdit" filterable clearable style="width: 100%;">
            <el-option
    ...
    <el-row>
      <el-col :span="6">
        <el-form-item label="许可证号"  label-width="110px" class="formItem">
          <el-input v-model="form.licenseKey" size="small" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="6">
        <el-form-item label="启运国（地区）" prop="originCountry" label-width="130px" class="formItem" required>
          <el-select v-model="form.originCountry" size="small" :filter-method="originCountryFilter" :disabled="isEdit" filterable clearable style="width: 100%">
            <el-option
      ...
      <el-col :span="6">
        <el-form-item label="经停港" prop="stopOverPort" label-width="110px" class="formItem" required>
          <el-select v-model="form.stopOverPort" size="small" :filter-method="stopOverPortsFilter" :disabled="isEdit" filterable clearable  style="width: 100%">
            <el-option
      ...
      <el-col :span="6">
        <el-form-item label="成交方式" prop="dealMode"  label-width="110px" class="formItem" required>
          <el-select v-model="form.dealMode" size="small" :filter-method="dealModeFilter" :disabled="isEdit" filterable clearable  style="width: 100%">
            <el-option
    ...
    <el-row>
      <el-col :span="4">
        <el-form-item label="运费" prop="freightMark" label-width="110px" class="formItem">
          <el-select v-model="form.freightMark"  filterable clearable size="small" :disabled="isEdit" @change="isFreightRateCurrencyDisabled">
      ...
      <el-col :span="2">
        <el-form-item class="formItem">
          <el-input v-model="form.freightRate"  size="small" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="2">
        <el-form-item class="formItem">
    ...
    <el-row>
      <el-col :span="6">
        <el-form-item label="包装种类" prop="packageType"  label-width="110px" class="formItem" required>
          <el-select v-model="form.packageType" :filter-method="packageTypesFilter" size="small" :disabled="isEdit" filterable clearable  style="width: 100%">
            <el-option
      ...
      <el-col :span="5">
        <el-form-item label="毛重（KG)" prop="grossWeight" required label-width="110px" class="formItem">
          <el-input v-model="form.grossWeight" :disabled="isEdit" @change="grossLimit" size="small"/>
        </el-form-item>
      </el-col>
      <el-col :span="5">
        <el-form-item label="净重（KG）" prop="netWeight" required label-width="110px" class="formItem">
          <el-input v-model="form.netWeight" :disabled="isEdit" @change="netLimit" size="small"/>
        </el-form-item>
      </el-col>
      <el-col :span="5">
        <el-form-item label="件数"  label-width="70px" prop="commodityQuantity" required class="formItem">
    ...
    <el-row>
      <el-col :span="6">
        <el-form-item label="贸易国别（地区）" prop="tradeCountry" label-width="135px" class="formItem" required>
          <el-select v-model="form.tradeCountry" :filter-method="tradeCountrysFilter" size="small" :disabled="isEdit" filterable clearable style="width: 100%;">
            <el-option
      ...
      <el-col :span="6">
        <el-form-item label="集装箱数"  label-width="110px" class="formItem">
    ...
    <el-row>
      <el-col :span="6">
        <el-form-item label="入境口岸" prop="entryPort" label-width="100px" class="formItem" required>
          <el-select v-model="form.entryPort" :filter-method="entryPortFilter" size="small" :disabled="isEdit" filterable clearable style="width: 100%;">
            <el-option
              v-for="item in entryPortsAll"
              :key="item.value"
              :label="item.label"
              :value="item.value">
              <span style="float: left">{{ item.value }}</span>
      ...
      <el-col :span="12">
        <el-form-item label="货物存放地点" prop="storagePlace" label-width="110px" class="formItem" required>
          <el-input v-model="form.storagePlace"  size="small" :disabled="isEdit"/>
        </el-form-item>
      </el-col>
      <el-col :span="6">
        <el-form-item label="启运港" prop="originPort" label-width="100px" class="formItem" required>
          <el-select v-model="form.originPort" :filter-method="originPortsFilter" size="small" :disabled="isEdit" filterable clearable style="width: 100%">
            <el-option
    ...
    <el-row>
      <el-col :span="6">
        <el-form-item label="报关单类型" prop="declarationType" label-width="100px" class="formItem" required>
          <el-select v-model="form.declarationType" size="small" :disabled="isEdit" filterable clearable >
            <el-option
      ...
      <el-col :span="10">
        <el-form-item label="备注"  label-width="110px" class="formItem">
      ...
      <el-dialog title="备注" :visible.sync="dialogremarkConVisible" width="45%" append-to-body>
        <div>
          <el-input v-model="remarkPer" type="textarea" :rows="7" placeholder="请输入内容" @keyup.enter.native="remarkChange" :disabled="isEdit"/>
    ...
    <el-row>
      <el-col :span="16">
        <el-form-item label="标记唛码" prop="marks" label-width="100px" class="formItem" required>
      ...
      <el-dialog title="标记唛码" :visible.sync="dialogremarkMarkVisible" width="45%" append-to-body>
        <div>
          <el-input v-model="marks" type="textarea" :rows="7" placeholder="请输入内容" @keyup.enter.native="remarkMaChange()" :disabled="isEdit"/>
      ...
      <el-dialog title="业务选择" :visible.sync="dialogBsSelectVisible" width="45%" append-to-body center>
        <div>
          <el-checkbox-group class="login-checkbox" v-model="selectBstype" @change="bsTypeChange" :disabled="isEdit">
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="检验检疫受理机关" prop="inspectionAndQuarantineOrgan" required label-width="150px" class="formItem">
                    <el-select v-model="formin.inspectionAndQuarantineOrgan" :filter-method="inspectAcceptOrgansFilter" :disabled="isEdit" size="small" filterable clearable  style="width: 100%">
                      <el-option
                ...
                <el-col :span="5">
                  <el-form-item label="企业资质"  label-width="90px" class="formItem">
              ...
              <el-row>
                <el-col :span="6">
                  <el-form-item label="领证机关" prop="certificationAuthority" required label-width="150px" class="formItem">
                    <el-select v-model="formin.certificationAuthority" :filter-method="certificationAuthoritysFilter" :disabled="isEdit" size="small" filterable clearable  style="width: 100%">
                      <el-option
                ...
                <el-col :span="6">
                  <el-form-item label="口岸检验检疫机关" prop="portInspectionAndQuarantineOrgan" required label-width="135px" class="formItem">
                    <el-select v-model="formin.portInspectionAndQuarantineOrgan" :filter-method="portInspectOrgansFilter" :disabled="isEdit" size="small" filterable clearable  style="width: 100%">
                      <el-option
                ...
                <el-col :span="6">
                  <el-form-item label="启运日期" prop="shipmentDate" required label-width="90px" class="formItem">
                    <el-date-picker
                      style="width: 100%"
                      v-model="formin.shipmentDate"
                      type="date"
                      placeholder="选择日期"
                ...
                <el-col :span="6">
                  <el-form-item label="B/L号	"  label-width="90px" class="formItem">
                    <el-input v-model="formin.blNo"  size="small" :disabled="isEdit"/>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="6">
                  <el-form-item label="目的地检验检疫机关" prop="desInspectionAndQuarantineOrgan" required label-width="150px" class="formItem">
                    <el-select v-model="formin.desInspectionAndQuarantineOrgan" :filter-method="destiInspectOrgansFilter" :disabled="isEdit" size="small" filterable clearable  style="width: 100%">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="关联号码及理由"  label-width="125px" class="formItem">
                    <el-input v-model="formin.associatedNo" size="small" :disabled="isEdit"/>
                  </el-form-item>
                </el-col>
                <el-col :span="5">
                  <el-form-item class="formItem">
                    <el-select v-model="formin.associatedReasons" size="small" :disabled="isEdit" filterable clearable  style="width: 100%">
                      <el-option
                ...
                <el-col :span="4">
                  <el-form-item  class="formItem">
                    <el-button size="small" style="margin-left: 20px;" @click="showUserInfo" type="primary">使用人</el-button>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="6">
                  <el-form-item label="原箱运输"  label-width="150px" class="formItem">
                    <el-select v-model="formin.originalboxTransportation" :disabled="isEdit" size="small">
                      <el-option
                ...
                <el-col :span="6">
                  <el-form-item label="特殊业务标识"  label-width="125px" class="formItem">
                ...
                <el-col :span="6">
                  <el-form-item class="formItem" label="所需单证	"  label-width="90px">
    ...
    <UserInfo ref="userInfo" @listenUserInfo="receiveUserInfo"/>
...
<script type="text/ecmascript-6">
  ...
  import CompanyAptitudeInfo from './components/companyAptitudeInfo.vue'
  ...
  import Selection from './components/specialServiceSelection.vue'
    export default {
        data() {
          ...
          var isRequiredEnterBorder = (rule,value,callback)=>{
            if (value == '' || !value) {
              return callback(this.$notify.error('进境关别不能为空！'));
            }
            else{
              callback()
            }
          ...
          var isRequiredCsCustomsCode = (rule,value,callback)=>{
            if (value == '' || !value) {
              return callback(this.$notify.error('消费使用单位海关代码不能为空！'));
            }
            else if(value.length != 10){
              return callback(this.$notify.error('消费使用单位海关代码只能为10位！'));
            }
            else{
              callback()
            }
          }
          var isRequiredCsCreditCode = (rule,value,callback)=>{
            if (value == '' || !value) {
              return callback(this.$notify.error('消费使用单位信用代码不能为空！'));
            }
            else if(value.length != 18){
              return callback(this.$notify.error('消费使用单位信用代码只能为18位！'));
            }
            else{
              callback()
            }
          }
          var isRequiredCsCompanyName = (rule,value,callback)=>{
            if (value == '' || !value) {
              return callback(this.$notify.error('消费使用单位名称不能为空！'));
            }
            else{
              callback()
            }
          }
          var isRequiredCsQuarantineCode = (rule,value,callback)=>{
            if(value != '' && value){
              if(value.length != 10){
                return callback(this.$notify.error('消费使用单位检验检疫编码只能为10位！'));
              }
              else{
                callback()
              }
          ...
          var isRequiredOriginCountry = (rule,value,callback)=>{
            if (value == '' || !value) {
              return callback(this.$notify.error('启运国(地区)不能为空！'));
            }
            else{
              callback()
            }
          }
          var isRequiredStopOverPort = (rule,value,callback)=>{
            if (value == '' || !value) {
              return callback(this.$notify.error('经停港不能为空！'));
            }
            else{
              callback()
            }
          ...
          var isRequiredEntryPort = (rule,value,callback)=>{
            if (value == '' || !value) {
              return callback(this.$notify.error('入境口岸不能为空！'));
            }
            else{
              callback()
            }
          ...
          return {
            ...
            rules:{
              ...
              enterBorder:[
                { validator: isRequiredEnterBorder, trigger: 'blur'}
              ],
              importDate:[
                { validator: isRequiredImportDate, trigger: 'blur'}
              ],
              recordNo:[
              ...
              csCustomsCode:[
                { validator: isRequiredCsCustomsCode, trigger: 'blur' }
              ],
              csCreditCode:[
                { validator: isRequiredCsCreditCode, trigger: 'blur' }
              ],
              csCompanyName:[
                { validator: isRequiredCsCompanyName, trigger: 'blur' }
              ],
              csQuarantineCode:[
                { validator: isRequiredCsQuarantineCode, trigger: 'blur' }
              ],
              ovRsComanyName:[
              ...
              originCountry:[
                { validator: isRequiredOriginCountry, trigger: 'blur' }
              ],
              stopOverPort:[
                { validator: isRequiredStopOverPort, trigger: 'blur' }
              ],
              entryPort:[
                { validator: isRequiredEntryPort, trigger: 'blur' }
              ],
              packageType:[
      ...
      methods:{
          ...
          for(var i =0 ;i<inputArry.length;i++){
            ...
            inputArry[i].onkeydown = function (e){  //这里一定要把e事件传入。IE不用写，FF得写。
              ...
              if(keyCode==13 && obj.type!= 'button'){
                ...
                if(this.index === 0){
                  inputArry[this.index+5].focus();
                }else if(this.index === 55 || this.index === 71 || this.index === 91 || this.index === 94){
                  console.log('not focus')
                }else if(this.index === 19){
                  inputArry[this.index+4].focus();
                }else if(this.index === 35 || this.index === 38 || this.index === 41 || this.index === 8 || this.index === 83){
                  inputArry[this.index+2].focus();
                }else if(this.index === 47 || this.index === 84){
                  inputArry[this.index+3].focus();
                }else{
        ...
        selectEnterprise(item){
          this.$axios3.post('/getRevEnterprise',{
            ...
            if(res.data.code === 200){
              ...
              this.form.teRsComanyName = resData.enterpriseName;
              ...
              if(resData.enterpriseNature === 1 || resData.enterpriseNature === 2){
                this.form.csCreditCode = resData.enterpriseCreditCode;
                this.form.csCustomsCode = resData.enterpriseCustomsCode
                this.form.csQuarantineCode = resData.enterpriseQuarantineCode
                this.form.csCompanyName = resData.enterpriseName
              }
              this.getInitData()
            }
          }).catch((e) => {
        ...
        selectCustomer(item){
          this.$axios3.post('/getOverseasRsCompany',{
            ...
            if(res.data.code === 200){
              ...
              this.form.originCountry = resData.arrivalCountry;
              this.form.originPort = resData.originPort;
              this.form.importPort = resData.entrytPort;
        ...
        //显示使用人对话框
        showUserInfo(){
          this.$refs.userInfo.showUserInfoDialog(this.formin.userInfoList);
        },
        receiveUserInfo(val){
          console.log(val)
          this.formin.userInfoList = val;
        },
        //显示企业资质信息
        showAptitudeInfo(){
        ...
        showQuaranDeclareInfo(){
          this.$refs.quaranDeclareInfo.isImport = true;
          ...
          this.$refs.quaranDeclareInfo.form.ovConsignorAddress = this.formin.ovConsignorAddress;
          this.$refs.quaranDeclareInfo.form.unloadedDate = this.formin.unloadedDate;
        ...
        //获取初始数据
        getInitData(){
          this.enterBorderFilter(this.form.enterBorder);
          this.declareCustomFilter(this.form.declareCustoms);
          this.supplyAreasFilter(this.form.importPort);
          this.tradeCountrysFilter(this.form.tradeCountry);
          this.originCountryFilter(this.form.originCountry);
          this.superviseModesFilter(this.form.supervisionMode);
          this.levyNaturesFilter(this.form.levyNature);
          this.originPortsFilter(this.form.originPort);
          this.stopOverPortsFilter(this.form.stopOverPort);
          this.entryPortFilter(this.form.entryPort);
        ...
        loadStaticData(){
          this.$axios.all([
            ...
            this.enterBordersAll = this.declareCustoms.slice(0,19);
            ...
            this.entryPortsAll = this.supplyAreas.slice(0,19);
        ...
        declareCustomFilter(query){
          if(query !== '' && query != null){
            ...
            console.log('ll',this.declareCustomsAll)
          }else {
            this.declareCustomsAll = this.declareCustoms.slice(0,19);
          }
        },
        enterBorderFilter(query){
          if(query !== '' && query != null){
            this.enterBordersAll = this.declareCustoms.filter(item => {
              return (item.value+item.label).toString().includes(query);
            })
          }else {
            this.enterBordersAll = this.declareCustoms.slice(0,19);
        ...
        //入境口岸
        entryPortFilter(query){
          if(query !== '' && query != null){
            this.entryPortsAll = this.supplyAreas.filter(item => {
              return (item.value+item.label).toString().includes(query);
            })
          }else {
            this.entryPortsAll = this.supplyAreas.slice(0,19);
