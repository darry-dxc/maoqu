<template>
  <div class="export-container">
    ...
    <el-table size="mini" :data="containerData" @row-click="selectedChange" @selection-change="deleteVal" height="150px" stripe>
      ...
      <el-table-column label="集装箱规格" prop="containerSpecfifcaton" width="130px" :formatter="containerFormat"/>
      <el-table-column label="拼箱标识" prop="lclMarker" :formatter="lclMarkerFormat"/>
    </el-table>
    <el-form :model="containerForm" :show-message="false" ref="containerForm" :disabled="isDisable">
      ...
      <el-form-item label="集装箱规格：" label-width="130px" class="formItem" prop="containerSpecfifcaton" required>
        <el-select v-model="containerForm.containerSpecfifcaton"  filterable clearable>
      ...
      <el-form-item label="自重(KG)：" label-width="130px" class="formItem">
        <el-input size="mini" v-model="containerForm.containerWeight"/>
      </el-form-item>
      ...
      <el-form-item label="商品项号关系：" label-width="130px" class="formItem" prop="commodityItemNoReleation" required>
        <el-input size="mini" v-model="containerForm.commodityItemNoReleation" disabled @keyup.enter.native="addContainer">
    ...
    methods:{
      ...
      addContainer(){
        if(this.containerForm.containerNo != ''
          && this.containerForm.containerSpecfifcaton != ''
          ...
          this.containerData.find((item)=>{
            if(item == this.isEditInfo){
              ...
              item.containerSpecfifcaton = this.containerForm.containerSpecfifcaton;
          ...
          if(isEdit == false) {
            this.containerData.push({
              ...
              containerSpecfifcaton:this.containerForm.containerSpecfifcaton,
      ...
      releation(){
        setTimeout(()=>{
          console.log('ll',this.containerForm.commodityItemNoReleation)
          if(this.containerForm.commodityItemNoReleation != ''){
