    ...
    <div style="height: 800px;overflow: auto">
      ...
      <el-form :model="declarationform">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="进境关别"  label-width="140px" required class="form-item-margin">
              <el-select v-model="declarationform.enterBorder" disabled :filter-method="enterBorderFilter" filterable clearable style="width: 100%;">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label="入境口岸" label-width="140px" class="form-item-margin">
              <el-select v-model="declarationform.importPort" disabled :filter-method="supplyAreasFilter" filterable clearable style="width: 100%;">
                <el-option
        ...
        <el-row>
          <el-form-item label="境内收发货人"  label-width="140px" class="form-item-margin">
            ...
            <el-col :span="6"><el-input v-model="declarationform.teRsComanyName" placeholder="企业名称(中文)" auto-complete="off" class="inputLable" disabled/></el-col>
          </el-form-item>
        </el-row>
        <el-row >
          <el-form-item label="境外收发货人"  label-width="140px" class="form-item-margin">
            ...
            <el-col :span="12"><el-input v-model="declarationform.ovRsComanyName" placeholder="企业名称(外文)" auto-complete="off" class="inputLable" disabled/></el-col>
          </el-form-item>
        </el-row>
        <el-row>
          <el-form-item label="消费使用单位" label-width="140px" class="form-item-margin">
            <el-col :span="6"><el-input v-model="declarationform.csCreditCode" placeholder="企业信用代码" auto-complete="off" class="inputLable" disabled/></el-col>
            <el-col :span="6"><el-input v-model="declarationform.csCustomsCode" placeholder="海关代码" auto-complete="off" class="inputLable" disabled/></el-col>
            <el-col :span="6"><el-input v-model="declarationform.csQuarantineCode" placeholder="检验检疫编码" auto-complete="off" class="inputLable" disabled/></el-col>
            <el-col :span="6"><el-input v-model="declarationform.csCompanyName" placeholder="企业名称(中文)" auto-complete="off" class="inputLable" disabled/></el-col>
          </el-form-item>
        </el-row>
        <el-row>
            <el-col :span="8">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="启运国(地区)" label-width="140px" class="form-item-margin" >
              <el-select v-model="declarationform.originCountry" disabled :filter-method="originCountryFilter" filterable clearable style="width: 100%">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label="启运港" label-width="140px" class="form-item-margin" >
              <el-select v-model="declarationform.originPort" disabled :filter-method="originPortsFilter" filterable clearable style="width: 100%">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label="经停港"  label-width="140px" class="form-item-margin">
              <el-select v-model="declarationform.stopOverPort" disabled :filter-method="stopOverPortsFilter" filterable clearable  style="width: 100%">
                <el-option
...
<script type="text/javascript">
  ...
  export default {
    ...
    computed:{
      ...mapState(['businessNo','nickCompanyName'])
    },
    mounted() {
    ...
    methods:{
      onload(){
        let inputArry = document.getElementsByTagName("input");
      ...
      refuseOrder(){
        this.$confirm('确定拒绝此订单?', '提示', {
          ...
          this.$axios8.get('refuseNewOrder',{
            params:{
      ...
      acceptOrder(){
        this.$confirm('确定接受此订单?', '提示', {
          ...
          this.$axios8.post('acceptNewOrder',params)
            .then((response) =>{
              console.log('已接受订单！',response);
              if(response.data.state === true){
                this.$message.success('已接受订单！');
                this.$parent.importShow(response.data.data.imDeclareDetailId);
              }else {
                this.$message.error(response.data.data);
                setTimeout(()=>{
                  this.$store.commit('delete2_tabs', '/personImportBs');
      ...
      findImportService(imDeclareServiceId,businessId){
        ...
        this.$axios8.post('getDeclareServiceInfo',param)
          .then((response) =>{
            console.log('数据',response);
            let resData = response.data.data;
            this.declarationform = resData;
            this.serviceNo = resData.serviceNo;
            this.imDeclareServiceId = resData.imDeclareServiceId;
            this.ownedEnterpriseId = resData.enterpriseId;
            this.ownedEnterpriseName = resData.enterpriseName;
            //tableData1 商品信息
            this.tableData1 = [];
            this.tableData2 = [];
            this.tableData3 = [];
      ...
      //获取初始数据
      getInitData(){
        this.enterBorderFilter(this.declarationform.enterBorder);
        this.declareCustomFilter(this.declarationform.declareCustoms);
        this.supplyAreasFilter(this.declarationform.importPort);
        this.tradeCountrysFilter(this.declarationform.tradeCountry);
        this.originCountryFilter(this.declarationform.originCountry);
        this.superviseModesFilter(this.declarationform.supervisionMode);
        this.levyNaturesFilter(this.declarationform.levyNature);
        this.originPortsFilter(this.declarationform.originPort);
        this.stopOverPortsFilter(this.declarationform.stopOverPort);
